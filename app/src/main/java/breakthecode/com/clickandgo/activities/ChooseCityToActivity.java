...
public class ChooseCityToActivity extends AppCompatActivity implements CitiesToRecViewAdapter.OnItemClickListener {
    private static final String TAG = "myLogs ChooseCity";

    private static String SERVER_URL = "http://ssh-vps.nazwa.pl:8080";
    public static final String CITY_PICKED = "CITY_TO_PICKED";

    private AppSharedPreferencesHelper sharedPrefs;

    private RecyclerView cityRecView;
    private EditText chooseCityToSearchEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_city_to);
    ...
    private void initWidgets(){
        ...
        cityRecView = findViewById(R.id.choose_cityTo_recView);
        chooseCityToSearchEditText = findViewById(R.id.chooseCityToSearchEditText);
        ...
        if(isNetworkAvailable()){
            ...
            dialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                ...
                public void onDismiss(DialogInterface dialogInterface) {
                    Intent intent = new Intent(ChooseCityToActivity.this, MainPanelActivity.class);
        ...
        Log.d(TAG, "requestListOfAllCities: SERVER URL - " + SERVER_URL);
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        adapter.setOnItemClickListener(ChooseCityToActivity.this);
                    }
                }, 1500);
            }
    ...
    protected void onResume() {
        super.onResume();
        Log.d(TAG, "onResume: ");
        chooseCityToSearchEditText.clearFocus();
    }
